...
<div class="col-sm-11 mt-3">
    <div  class="container-fluid" id="content-add-group">
        <div class="row">
            <div class="col-sm-11 dashGroupe">
                <div class="addTeacherFormWrapper">
                    ...
                    <form method="POST" id="groupeForm">
                        ...
                        <div class="input-group my-3">
                            <button type="button" class="btn btn-success mx-3" id="submit" name="ajouterGroupe"  onclick="save_groupe();return false;">Ajouter Groupe</button>
                        </div>
                    </form>
                </div>
            </div>
            <div class="col-sm-11 mainGroup">
                <div id="groupeList"  class="my-5">
                    
                    <?php
                        $select1 = new SQLiteSelect($cnx);
                        $groupes = $select1->getGroupes();
                        echo "<center><table class='table table-dark table-striped table-hover'>
